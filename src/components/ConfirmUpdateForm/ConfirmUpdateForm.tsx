...
function ConfirmUpdateForm({
  ...
  isOpen: boolean;
  setOpenConfirmUpdateForm: (open: boolean) => void;
  ...
  const handleClose = () => setOpenConfirmUpdateForm(false);
    ...
    <div>
      ...
      >
        <Box sx={style}>
          ...
          <p className={styles.heading}>Confirm action</p>
          <p className={styles.description}>Do you want to perform this action?</p>
